...
/* Process Extensions created by Yating Zhou, Lun Li */
#define TOPIC_CREATE  				35
#define TOPIC_PUBLISHER 			44
#define MSEND       				56 /* to PM: send message into a group.*/
#define MRECEIVE    				58 /* to PM: receive message from group.*/
#define ADDPROC     				69	/* to PM: add proc into a message group.*/
#define RMPROC      				70	/* to PM: rm proc from a message group.*/
#define TOPIC_INIT 					79
#define TOPIC_RECEIVE_MSG 			97
#define TOPIC_DISPLAY_TOPIC 		103
#define TOPIC_SUBSCRIBER 			105 /* do_topic subscriber */
...
#define TOPIC_PUBLISH_MSG 			114 /* do_publish_msg */
#define TOPIC_DISPLAY_MSG_TABLE 	115
#define TOPIC_DISPLAY_SUB 			116
#define TOPIC_DISPLAY_PUB 			117
