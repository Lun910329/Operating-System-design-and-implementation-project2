...
#  define SYS_IPCERRDTCT (KERNEL_CALL + 57)	/* sys_ipcerrdtct(): add by Yating Lun Ban Xuliang */
#  define SYS_SINGLEIPC (KERNEL_CALL + 58)	/* sys_singleipc(): add by Yating Lun Ban Xuliang */
